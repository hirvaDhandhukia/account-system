...
if(isset($_POST['reset-request-submit'])) {
    ...
    $url = "www.localhost/account-system/admin/create-new-password-admin.php?selector=" . $selector . "&validator=" . bin2hex($token);
    ...
    header("location: ../reset-password-admin.php?reset=success");
